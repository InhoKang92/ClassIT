...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <img src="https://github.com/user-attachments/assets/7754bd6a-5c14-4e6e-bbdf-78ca5e0de512" />
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <img src="https://github.com/user-attachments/assets/d2ef91be-11d3-4065-8531-77e9ca58bd4a" />
      </td>
       <td>
        <img src="https://github.com/user-attachments/assets/4c356382-9991-45e7-a2c2-e7b5ef9db075" />
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        <img src="https://github.com/user-attachments/assets/1c51dcac-3fde-4853-b3dc-3a1360a5ca26" />
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <img src="https://github.com/user-attachments/assets/9ee75f61-05f6-4a21-a390-738a589efd1e" />
      </td>
      <td>
        <img src="https://github.com/user-attachments/assets/eee352c4-da40-468f-90a2-8595d137c43e" />
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <img src="https://github.com/user-attachments/assets/2a1db425-72a9-4ca1-9611-e7a7ceb2a2c9" />
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <img src="https://github.com/user-attachments/assets/c02096a0-6d09-43d3-9d4b-dafca852b5eb" />
      </td>
      <td>
        <img src="https://github.com/user-attachments/assets/ad1d9673-885f-4b17-a260-5d879944f858" />
      </td>
    </tr>
    <tr>
      <td>
...
+ 회원가입
  ...
  ![회원가입 (3)](https://github.com/user-attachments/assets/7d89fd5e-7263-4454-9eeb-3fa09d4b2c42)
...
+ 마이페이지
  ...
  ![회원정보수정](https://github.com/user-attachments/assets/ef27a2cc-febe-403b-816e-ded88575b81f)
  
  + 예약/리뷰 페이지에서는 나의 예약 정보를 '예정된 클래스'와 '완료된 클래스'로 구분하여 확인할 수 있습니다.
  + '예정된 클래스'는 결제 취소 버튼을 통해 예약을 취소할 수 있고, '완료된 클래스'는 리뷰를 작성하거나 이미 작성한 리뷰를 수정/삭제할 수 있습니다.
  
  ![마이페이지리뷰](https://github.com/user-attachments/assets/8a2b8829-c8b1-401d-aacf-332d55cc3157)
  
  + Q&A 페이지에서는 나의 문의 내역을 '미답변' 문의 내역과 '답변완료' 문의 내역으로 구분하여 확인할 수 있습니다.

  ![마이페이지큐앤에이](https://github.com/user-attachments/assets/137fb1c1-cabb-4f94-9ec6-cd78500ec6db)
...
+ 관리페이지
  ...
  ![관리페이지예약관리](https://github.com/user-attachments/assets/e9a7c1da-77fe-49a5-bae5-8596a4e13a45)

  + Q&A 관리 페이지에서는 내 클래스에 들어온 문의 내역을 '미답변', '답변완료' 목록으로 구분하여 확인할 수 있습니다.
...
![클래스검색](https://github.com/user-attachments/assets/7dfbaf3c-a042-4eaa-9e53-d44b17d70aa9)
...
![클래스추천](https://github.com/user-attachments/assets/a47b689d-cb04-46aa-bff3-7c7af99a305d)
